...
if ($transactionId != NULL){
    ...
    $mysqli = new mysqli("127.0.0.1", "vincerap7132_testing1", "Test013020#", "vincerap7132_testing");
        ...
        $updateSql2 = "UPDATE `withdrawals` SET `status`= 'Verified' WHERE `transaction_id` = '$transactionId'";
        //echo $insertSql2;
        
        $uresult = $mysqli->query($updateSql2);
...
<p style="text-align:center;">Validation Completed</p>
</div>
    </div>
    <div id="footer" class="form-footer">
      
      <div>
  <a href="https://www.jotform.com/?utm_source=thankyoupage&utm_medium=content&utm_content=thankyou_footer_banner&utm_campaign=form_thankyou_page_new_hp&utm_term=91284364186463" target="_blank" style="text-decoration: none; color: #fff; background-color: #f98e03; border-radius: 3px; float: right; padding: 9px 15px; font-size: 14px; display: inline-block; vertical-align: middle;">Create a JotForm</a>
  <div style="color: #575757">
  <a href="https://www.jotform.com/?utm_source=thankyoupage&utm_medium=content&utm_content=thankyou_footer_text&utm_campaign=form_thankyou_page_new_hp&utm_term=91284364186463" target="_blank" style="text-decoration: none; color: black;">Now create your own JotForm - <span style="color: #b1b0b0;">It’s free! </span></a>
  </div>
</div>
    </div>
  </body>
